...
# ----------------------------------------------------------------------------
# HyperAdaptiveSplitAI: HyperAdaptiveAI with three independent linear bid
# models (one per auction type) instead of a single shared discount.
#
...
# `_hyper_compute_discount_features` can be reused unchanged.
#
# This is the class that `scripts/evolve_hyper_adaptive.py` tunes via a
